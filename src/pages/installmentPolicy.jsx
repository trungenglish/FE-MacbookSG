            ...
            <main className="bg-gray-50 py-8">
                <div className="container mx-auto px-4">
                    ...
                    <section className="bg-white p-6 rounded-lg shadow-md mb-8">
                        <h2 className="text-xl font-semibold mb-4">1. Trả góp qua Công ty tài chính (HD SAISON, Mirae
                            Asset)</h2>
                        <ul className="space-y-3 text-gray-700">
                            <li>- Mua hàng trả góp qua các công ty tài chính yêu cầu khách hàng phải trả trước bằng tiền
                                mặt từ 20% đến 70% giá trị sản phẩm.
                            </li>
                    ...
                    <section className="bg-white p-6 rounded-lg shadow-md mb-8">
                        ...
                        <p className="text-gray-700">
                            Khách hàng có thể thanh toán bằng các loại thẻ của các ngân hàng tại Việt Nam và thế giới
                            bao gồm: Visa, JCB, Master Card.
                        </p>
                    </section>
...
export default InstallmentPolicyPage;